...
# !!!!
# please modify the project folder as your own
# !!!!
#
create_project zynq_hw "./" -part xc7z010clg400-1
...
#
make_wrapper -files [get_files "$proj_dir/zynq_hw.srcs/sources_1/bd/zynq_basic/zynq_basic.bd"] -top
add_files -norecurse "$proj_dir/zynq_hw.srcs/sources_1/bd/zynq_basic/hdl/zynq_basic_wrapper.vhd"
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
generate_target all [get_files  "$proj_dir/zynq_hw.srcs/sources_1/bd/zynq_basic/zynq_basic.bd"]
