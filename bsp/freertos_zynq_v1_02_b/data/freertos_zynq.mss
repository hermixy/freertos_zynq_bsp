...
BEGIN LIBRARY
 ...
 PARAMETER N_TX_DESCRIPTORS = 64
 PARAMETER N_RX_DESCRIPTORS = 64
 PARAMETER MEMP_N_PBUF = 16
 PARAMETER MEMP_N_TCP_SEG = 256
 PARAMETER PBUF_POOL_SIZE = 256
 PARAMETER TCP_WND = 2048
 PARAMETER TCP_SND_BUF = 8192
 PARAMETER MEM_SIZE = 0x20000
 PARAMETER MEMP_N_TCP_PCB = 32
 PARAMETER MEMP_N_UDP_PCB = 4
 PARAMETER IP_REASS_MAX_PBUFS = 10
END
...
BEGIN LIBRARY
 PARAMETER LIBRARY_NAME = freertos_cli
 PARAMETER PROC_INSTANCE = ps7_cortexa9_0
END
