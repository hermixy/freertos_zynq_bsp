...
proc generate {os_handle} {
    ...
    file copy -force [file join src Source portable common printf_stdarg.c] ./src
    file copy -force [file join src Source portable common mem_stdc.c] ./src
    file copy -force [file join src Source portable common mem_stdc.h] ./src
    file copy -force [file join src Source portable common platform.c] ./src
    file copy -force [file join src Source portable common platform.h] ./src
    file copy -force [file join src Source portable common platform_config.h] ./src
    file copy -force [file join src Source portable common rtos_hooks.c] ./src
    file copy -force [file join src Source portable common rtos_hooks.h] ./src
...
*/"
    ...
    # hooks
    set use_hooks [expr [get_property CONFIG.hook_functions $os_handle] == true]
    puts $config_file "\#define configUSE_HOOKS $use_hooks"
    ...
    set use_stack_overflow_hook [expr [get_property CONFIG.use_stack_overflow_hook $os_handle] == true]
    puts $config_file "\#define configUSE_STACK_OVERFLOW_HOOK $use_stack_overflow_hook"
